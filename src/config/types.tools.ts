  ...
  web?: {
    search?: {
      ...
      perplexity?: {
        ...
        apiKey?: SecretInput;
        /** Base URL override for Perplexity-compatible search. Use https://openrouter.ai/api/v1 for OpenRouter-backed Sonar models. */
        baseUrl?: string;
        /** Model override for OpenRouter-backed Perplexity search (default: "perplexity/sonar-pro"). */
        model?: string;
      };
